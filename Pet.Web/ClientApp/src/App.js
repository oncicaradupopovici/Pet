...
import ExpenseCategoryMonthPieChart from './components/Charts/ExpenseCategoryMonthPieChart';
...
export default () => (
  <Layout>
    ...
    <Route exact path='/chart/month' component={ExpenseCategoryMonthPieChart} />
  </Layout>
);
